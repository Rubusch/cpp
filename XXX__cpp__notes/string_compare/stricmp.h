...
namespace IgnoreCase
{
  ...
  struct NoCaseLess_t : std::binary_function< std::string, std::string, bool > {
    bool operator()(const std::string &Str1, const std::string &Str2) const
    {
      return std::lexicographical_compare(
          Str1.begin(), Str1.end(), Str2.begin(), Str2.end(), CharLess_t());
    }
  };
  ...
  struct NoCaseCmp_t : std::binary_function< std::string, std::string, bool > {
    int operator()(const std::string &Str1, const std::string &Str2) const
    {
      ...
      if (Result.first == Shorter->end()) {
        if (Result.second == Longer->end()) { // Strings sind gleich
          return 0;
        } else { // Der erste String war kürzer als der zweite.
  ...
  bool LocNoCaseEqual(const std::string &Str1, const std::string &Str2,
                      const std::locale &loc)
  {
    return LocNoCaseEqual_t(loc)(Str1, Str2);
  }

  struct LocNoCaseLess_t
      : std::binary_function< std::string, std::string, bool > {
    LocNoCaseLess_t(const std::locale &loc = std::locale::classic())
        : m_Loc(loc)
    {
    }
  ...
  bool LocNoCaseLess(const std::string &Str1, const std::string &Str2,
                     const std::locale &loc)
  {
    return LocNoCaseLess_t(loc)(Str1, Str2);
  }

  struct LocNoCaseCmp_t
      : std::binary_function< std::string, std::string, bool > {
  ...
  int LocNoCaseCmp(const std::string &Str1, const std::string &Str2,
                   const std::locale &loc)
  {
    return LocNoCaseCmp_t(loc)(Str1, Str2);
  }

  struct LocTableNoCaseEqual_t
      : std::binary_function< std::string, std::string, bool > {
    LocTableNoCaseEqual_t(const std::locale &loc = std::locale::classic())
        : m_Loc(loc)
    {
    }
  ...
  bool LocTableNoCaseEqual(const std::string &Str1, const std::string &Str2,
                           const std::locale &loc)
  {
    return LocTableNoCaseEqual_t(loc)(Str1, Str2);
  }

  struct LocTableNoCaseLess_t
      : std::binary_function< std::string, std::string, bool > {
    LocTableNoCaseLess_t(const std::locale &loc = std::locale::classic())
        : m_Loc(loc)
    {
    }
  ...
  bool LocTableNoCaseLess(const std::string &Str1, const std::string &Str2,
                          const std::locale &loc)
  {
    return LocTableNoCaseLess_t(loc)(Str1, Str2);
  }

  struct LocTableNoCaseCmp_t
      : std::binary_function< std::string, std::string, bool > {
    LocTableNoCaseCmp_t(const std::locale &loc = std::locale::classic())
        : m_Loc(loc)
    {
    }
  ...
  int LocTableNoCaseCmp(const std::string &Str1, const std::string &Str2,
                        const std::locale &loc)
  {
