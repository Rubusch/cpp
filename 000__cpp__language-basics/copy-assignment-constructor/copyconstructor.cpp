...
/*
  ...
  Use the copy constructor especially for classes with dynamically allocated
memory!
...
public:
  ...
  Box(const Box &box)
  {
    ...
    // if (this == &box) return; // code joke: "box" can never be this in this's
    // constructor - this line is useless! (Exceptional C++, Herb Sutter, 2000)

    // deep copy!
    //
    // this has to be another allocation!
    // if it was just a reference to the orig element, calling 'delete' in on of
    // both objects on 'pItem' will result in unallocated memory in the other
    // object for 'pItem'
