...
int main()
{
  ...
  cout << "The type of \'str\' is:\t\t" << typeid(str).name() << "\t\t(string)\n";
  cout << "The type of \'longVar1\' is:\t" << typeid(longVar1).name() << "\t\t(long)\n";
  cout << "The type of \'longVar2\' is:\t" << typeid(longVar2).name() << "\t\t(long)\n";
  cout << "The type of \'sc\' is:\t\t" << typeid(sc).name() << "\t(class SomeClass)\n";
  cout << "The type of \'ac\' is:\t\t" << typeid(ac).name() << "\t(class AnyClass)\n";
  cout << "The type of \'*pChar\' is:\t" << typeid(*pChar).name() << "\t\t(dereferenced pointer to char)\n";
  cout << "The type of \'pChar\' is:\t\t" << typeid(pChar).name() << "\t\t(pointer to char)\n";
