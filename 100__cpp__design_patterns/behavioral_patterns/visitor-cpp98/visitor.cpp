...
{
public:
  void sayHello() { std::cout << "\t\t\"Hello, from Element1!\"\n"; }
...
{
public:
  void visit(Element1 &element) const { element.sayHello(); }
...
void Element1::accept(Visitor *visitor) { visitor->visit(*this); }


void Element2::accept(Visitor *visitor) { visitor->visit(*this); }
