...
/*
  ...
  a) define new links (usually in the handler, but ConcreteHandler
...
struct ConcreteHandler1 : public Handler {
...
struct ConcreteHandler2 : public Handler {
