...
SmallObjectAllocator::SmallObjectAllocator( std::size_t chunkSize, std::size_t maxObjectSize)
  : pLastAlloc_(NULL), pLastDealloc_(NULL), chunkSize_(chunkSize), maxObjectSize_(maxObjectSize)
{
  std::cout << "\t\tSmallObjectAllocator::SmallObjectAllocator( std::size_t chunkSize, std::size_t maxObjectSize) - ctor\n";
}
