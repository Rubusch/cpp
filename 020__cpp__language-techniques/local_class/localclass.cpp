...
public:
  /*
    BTW.: Deleting a derived class object using a pointer to a base class that
...
Interface *MakeAdapter(const T &arg1, const P &arg2)
{
  ...
  public:
    LocalClass(const T &arg1, const P &arg2) : arg1_(arg1), arg2_(arg2)
    {
      cout << "Local Class initialized.\n";
    }

    ~LocalClass() { cout << "Local Class deleted\n"; }
...
int main()
{
  ...
  if (NULL ==
      (pLocalObject = MakeAdapter< string, int >("Hello World!", 1234567))) {
