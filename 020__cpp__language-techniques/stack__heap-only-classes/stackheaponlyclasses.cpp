// heaponly.cpp
/*
  this class can only be constructed on the heap, because of the private
declaration of its destructor.

  No instance on the stack will be possible as also no direct call to the
destructor!
//*/
