...
/*
  ...
  adjacent_difference - compute the differences between adjacent elements in a
range
...
int main()
{
  ...
  int arr_diff[4];
  fill(arr_diff, arr_diff + 4, 0);
  cout << "arr: \t";
  copy(arr, arr + 4, ostream_iterator< int >(cout, " "));
  cout << endl << endl;

  cout << "adjacent_difference() - difference to the predecessor, starting at "
          "0\n";
