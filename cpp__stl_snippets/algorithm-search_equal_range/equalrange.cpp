...
int main()
{
  ...
  cout << "\'2\' can be inserted in the range starting at " << (pa.first - arr_a)
       << " to " << (pa.second - arr_a) << endl;
  cout << "Hence, there are " << (pa.second - pa.first) << " elements with the value \'2\'\n";
  cout << endl;
