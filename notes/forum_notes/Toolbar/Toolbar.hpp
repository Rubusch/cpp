...
private slots:
  void slotInsertLetter()
  {
    ...
    /*
            Zumindest Frage zwei und drei lässt sich durch ein leichtes suchen
    in der Doku finden... http://doc.trolltech.com/4.3/qlineedit.html

            Das gerade aktive QLineEdit rauszufinden ist etwas schwieriger, da,
    sobald man einen Button anklickt, das LineEdit ja nicht mehr aktiv ist...
    aber da das QLineEdit kurz bevor es den Fokus verliert, ein Signal aussendet
    (void QLineEdit::editingFinished ()) sollte auch das kein Problem sein.
    (Christian81, QtForum.de)
    //*/
  };
